...
class DiffusionModel(nn.Module):
    ...
    def forward(self, images, labels=None):
        noisy_images, timesteps, expected_noise = self.get_training_data(images)
...
denoised_images = diffusion_model.denoise(noisy_images, None, selected_timestep)
...
denoised_images = diffusion_model.denoise(noisy_images, None)
plot_images(denoised_images.permute(0, 2, 3, 1).cpu().numpy())
